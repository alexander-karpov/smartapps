...
def _create_hagi_dialog() -> Dialog:
    ...
    @on('здравтвуйте, добрый день, доброе утро, привет хаги ваги')
    def _():
    ...
    @on('хороший хаги ваги, ты хороший, ты молодец, ты мне нравишься, ты мой любимчик')
    def _():
        say('Ты тоже.')
    ...
    @on('а ты меня видишь, ура ты меня не видишь, ты меня не увидишь, хакик меня видишь в игре')
    def _():
        say(random.choice((
            'Я слежу за тобой',
