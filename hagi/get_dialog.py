...
def _create_hagi_dialog() -> Dialog:
    ...
    def _():
        say(random.choice((
            ...
            'Я синий и мягкий. Я был добрым.',
        )))

        say(random.choice((
            'Потом они оживили меня, так что беги.',
            'Но им не нужен был хороишй Х+аги.',
            'Они хотели сделать меня плохим. Но у них не получилось. Да ведь?',
        )))
