...
def _create_hagi_dialog() -> Dialog:
    ...
    on, say, postroll, input = (
        dialog.append_handler,
        dialog.append_reply,
        dialog.append_postroll,
        dialog.input,
    )
    ...
    @on(
        "так ты повторяешь",
        "хватит повторять",
        "зачем ты всё время повторяешь",
        "ты что за мной повторяешь офигел",
        "ну не повторяй за мной пожалуйста",
    )
    def _():
        say(
            random.choice(
    ...
    def _():
        say(random.choice(("Расскажи мне про человечков.",)))
        ...
        say(random.choice(("Мне будет легче ловить", "Это мне поможет. Ням-ням")))

    @on(
        "выходи",
        "а ты не можешь себя показать",
        "покажи себя пожалуйста",
